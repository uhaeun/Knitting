...
const ALL = ['tour', 'install-guide', 'ux', 'ready', 'crud', 'caption', 'avatar', 'project-dates', 'password-reset', 'legal', 'delete-account', 'email-confirm', 'share', 'result-ratios', 'video-results', 'video-capture'];
