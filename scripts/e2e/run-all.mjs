...
const ALL = ['tour', 'install-guide', 'ux', 'ready', 'crud', 'caption', 'avatar', 'project-dates', 'explore-popular', 'password-reset', 'legal', 'delete-account', 'email-confirm', 'share', 'result-ratios', 'video-results', 'video-capture'];
