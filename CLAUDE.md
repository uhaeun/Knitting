...
> 이 절은 단계가 바뀔 때마다 갱신한다. **현재: 1주차 — 로컬 저장 우선. 화면 6단계 구현 완료(2026-09-06), 도그푸딩 중**
...
- **영상 인코딩을 구현하지 않는다** (2주차 스파이크에서 별도로 다룸)
...
src/
  ...
  shared/
    ...
    types/              타입
modules/
  video-encoder/        네이티브 영상 인코더 (스파이크)
docs/                   설계도, 스파이크 기록
scripts/                검증 도구
```
